...
const AddRoom = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-7xl mx-auto mt-6">
        <form action={formAction}>
          <div className="mb-4">
            ...
            <input
              ...
              id="name"
              name="name"
              className="border border-gray-300 rounded w-full py-2 px-3 placeholder-gray-300"
          ...
          <div className="mb-4">
            ...
            <textarea
              id="description"
              name="description"
              className="border border-gray-300 rounded w-full h-24 py-2 px-3 placeholder-gray-300"
